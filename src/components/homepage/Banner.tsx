  ...
  return (
    <section className="py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="relative overflow-hidden rounded-3xl bg-black p-6 md:p-10 lg:p-14 shadow-xl">
          {/* Decorative Circle */}
          ...
          <div className="relative grid grid-cols-1 items-center gap-10 md:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-lg text-base leading-7 text-white md:text-lg">
